...
*   you should not be very expalantory. just give the heardes, bullet the most important keyword and features that address the issue. i.e enableing rate limit on service mesh is enough and you dont neeed explain it. don't be chatty. be structural with headres, bullets and keywords to show you knoe the most important features
